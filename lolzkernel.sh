...
git clone https://Jprimero15:$GITHUB_TOKEN@github.com/Jprimero15/android_kernel_xiaomi_sdm439-4.19 -b v26-merge --depth=1 $LOLZ_DIR/lolz
...
cd $LOLZ_DIR/lolz
bash $LOLZ_DIR/lolz/builder/current_lolzbuilder.sh ksu
