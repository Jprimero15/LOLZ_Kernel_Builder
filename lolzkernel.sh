...
git clone https://github.com/Jprimero15/lolz_kernel_redmi8 -b v27-test --depth=1 $LOLZ_DIR/lolz
...
cd $LOLZ_DIR/lolz
bash $LOLZ_DIR/lolz/builder/current_lolzbuilder.sh test clanglto
