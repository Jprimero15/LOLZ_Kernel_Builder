...
mkdir -p $LOLZDIR/clang_tc && curl -L "https://github.com/ZyCromerZ/Clang/releases/download/15.0.7-20230204-release/Clang-15.0.7-20230204.tar.gz" | tar -xz -C $LOLZDIR/clang_tc
