...
git clone https://github.com/Jprimero15/android_kernel_xiaomi_sdm439-4.19 -b vauxite_new --depth=1 $LOLZ_DIR/lolz
...
cd $LOLZ_DIR/lolz && bash $LOLZ_DIR/lolz/builder/new_lolzbuilder.sh ksu
